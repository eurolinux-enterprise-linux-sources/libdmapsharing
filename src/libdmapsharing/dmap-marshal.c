...
void
dmap_marshal_STRING__STRING (GClosure     *closure,
...
extern void dmap_marshal_VOID__ULONG_FLOAT (GClosure     *closure,
                                            ...
                                            gpointer      marshal_data);
void
dmap_marshal_VOID__ULONG_FLOAT (GClosure     *closure,
                                GValue       *return_value G_GNUC_UNUSED,
                                guint         n_param_values,
                                const GValue *param_values,
                                gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void dmap_marshal_STRING__ULONG_ULONG (GClosure     *closure,
                                              ...
                                              gpointer      marshal_data);
void
dmap_marshal_STRING__ULONG_ULONG (GClosure     *closure,
                                  GValue       *return_value G_GNUC_UNUSED,
                                  guint         n_param_values,
                                  const GValue *param_values,
                                  gpointer      invocation_hint G_GNUC_UNUSED,
                                  gpointer      marshal_data)
{
  typedef gchar* (*GMarshalFunc_STRING__ULONG_ULONG) (gpointer     data1,
                                                      gulong       arg_1,
                                                      gulong       arg_2,
                                                      gpointer     data2);
  ...
  callback = (GMarshalFunc_STRING__ULONG_ULONG) (marshal_data ? marshal_data : cc->callback);
...
extern void dmap_marshal_ULONG__VOID (GClosure     *closure,
                                      ...
                                      gpointer      marshal_data);
void
dmap_marshal_ULONG__VOID (GClosure     *closure,
                          GValue       *return_value G_GNUC_UNUSED,
                          guint         n_param_values,
                          const GValue *param_values,
                          gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void dmap_marshal_VOID__STRING_STRING (GClosure     *closure,
                                              ...
                                              gpointer      marshal_data);
void
dmap_marshal_VOID__STRING_STRING (GClosure     *closure,
                                  GValue       *return_value G_GNUC_UNUSED,
                                  guint         n_param_values,
                                  const GValue *param_values,
                                  gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void dmap_marshal_VOID__STRING_BOOLEAN (GClosure     *closure,
                                               ...
                                               gpointer      marshal_data);
void
dmap_marshal_VOID__STRING_BOOLEAN (GClosure     *closure,
                                   GValue       *return_value G_GNUC_UNUSED,
                                   guint         n_param_values,
                                   const GValue *param_values,
                                   gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void dmap_marshal_BOOLEAN__STRING (GClosure     *closure,
                                          ...
                                          gpointer      marshal_data);
void
dmap_marshal_BOOLEAN__STRING (GClosure     *closure,
                              GValue       *return_value G_GNUC_UNUSED,
                              guint         n_param_values,
                              const GValue *param_values,
                              gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void dmap_marshal_VOID__STRING_POINTER_POINTER_POINTER_BOOLEAN (GClosure     *closure,
                                                                       ...
                                                                       gpointer      marshal_data);
void
dmap_marshal_VOID__STRING_POINTER_POINTER_POINTER_BOOLEAN (GClosure     *closure,
                                                           GValue       *return_value G_GNUC_UNUSED,
                                                           guint         n_param_values,
                                                           const GValue *param_values,
                                                           gpointer      invocation_hint G_GNUC_UNUSED,
                                                           gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__STRING_POINTER_POINTER_POINTER_BOOLEAN) (gpointer     data1,
                                                                             gpointer     arg_1,
                                                                             gpointer     arg_2,
                                                                             gpointer     arg_3,
                                                                             gpointer     arg_4,
  ...
  callback = (GMarshalFunc_VOID__STRING_POINTER_POINTER_POINTER_BOOLEAN) (marshal_data ? marshal_data : cc->callback);
